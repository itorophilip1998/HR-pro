  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-10">
        <motion.div
          className="absolute top-20 left-20 w-96 h-96 bg-green-600 rounded-full mix-blend-multiply filter blur-3xl"
          animate={{
            x: [0, 100, 0],
            y: [0, 50, 0],
          }}
        ...
        />
        <motion.div
          className="absolute top-40 right-20 w-96 h-96 bg-emerald-700 rounded-full mix-blend-multiply filter blur-3xl"
          animate={{
            x: [0, -100, 0],
            y: [0, -50, 0],
          }}
      ...
      <div className="max-w-4xl w-full mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <div className="w-24 h-24 mx-auto bg-gradient-to-br from-green-600 to-green-800 rounded-3xl flex items-center justify-center shadow-2xl">
          ...
          {/* Title */}
          <motion.h1
            className="text-6xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-green-900"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-gradient-to-r from-green-600 to-green-800 text-white font-bold rounded-xl shadow-2xl hover:from-green-500 hover:to-green-700 transition-all text-lg"
          >
            🚀 Use Demo Account
          </motion.button>
          <Link href="/signup">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white text-green-700 font-bold rounded-xl shadow-xl hover:bg-gray-50 border-2 border-green-600 transition-all text-lg"
            >
              Get Started
            </motion.button>
          </Link>
        ...
        >
          ...
          >
            <div className="text-center mb-6">
              <div className="w-16 h-16 mx-auto bg-gradient-to-br from-green-600 to-green-800 rounded-2xl flex items-center justify-center mb-4">
            ...
            <div className="space-y-4 mb-6">
              <div className="bg-green-50 rounded-xl p-4 border border-green-200">
                <label className="text-sm font-semibold text-green-700 mb-1 block">Email</label>
                <div className="flex items-center justify-between">
                  <code className="text-green-900 font-mono text-lg">admin@hr-pro.com</code>
                  <button
                    onClick={() => {
              ...
              <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-200">
                <label className="text-sm font-semibold text-emerald-700 mb-1 block">Password</label>
                <div className="flex items-center justify-between">
                  <code className="text-emerald-900 font-mono text-lg">admin123</code>
                  <button
                    onClick={() => {
            ...
            <div className="flex flex-col gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-4 bg-gradient-to-r from-green-600 to-green-800 text-white font-bold rounded-xl shadow-lg hover:from-green-500 hover:to-green-700 transition-all"
              >
                📋 Copy & Sign In
              </motion.button>
              <button
